...
var draw = SVG().addTo("#riboswitch").size(canvasW, canvasH);
draw
  .line(adnX, adnY, canvasW, adnY)
...
let headX = adnX + posLeft + (hline - 25);
...
if (strand === "reverse") {
  ...
  group.add(head);
  group.add(body);
  group.rotate(180).move(posLeft + adnX, headY - altura - 34);
}
